...
(function ($, window, document, undefined) {
  ...
  editable.prototype = {
    ...
    edit: function () {
      ...
      // Store the course ID from the row's data attribute
    ...
    save: function () {
      ...
      $.ajax({
        ...
        error: function (xhr, status, error) {
          ...
          instance.cancel();
          showNotification('Failed to update course: ' + error, 'error');
        },
      });
  ...
  $("button[aria-label='Delete']").click(function (e) {
    ...
    if (confirm('Are you sure you want to delete this course?')) {
      $.ajax({
        ...
        error: function (xhr, status, error) {
          showNotification('Failed to delete course: ' + error, 'error');
        },
      });
    }
  });
